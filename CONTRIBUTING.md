# Contributing to Llama Proxy

Thank you for your interest in contributing to Llama Proxy! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Proxy:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-proxy.git
   cd llama-proxy
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-proxy.git
   ```
...
By contributing to Llama Proxy, you agree that your contributions will be licensed under the project's MIT License.
